...
public class VirtualMotor {
	...
	// causes motor to rotate through angle;
	// if immediateReturn is true, method returns immediately and the motor
	// stops by itself
	// If any motor method is called before the limit is reached, the rotation
	// is canceled.
	...
	// Then getTachoCount should be within +- 2 degrees of the limit angle when
	// the method returns
	...
	// if immediateReturn is true, method returns immediately and the motor
	// stops by itself
	// and getTachoCount should be within +- 2 degrees if the limit angle If any
	// motor method is called before the limit is reached, the rotation is
	// canceled.
...
//	}
//
//	// returns actualSpeed degrees per second, calculated every 100 ms; negative
